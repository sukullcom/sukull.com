...
export default function TimeSlotGrid({ 
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      clientLogger.error({ message: "TimeSlotGrid error", error, location: "components/TimeSlotGrid" });
    } finally {
      setIsSaving(false);
    }
  };
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    clientLogger.error({ message: "check profile failed", error, location: "components/TimeSlotGrid/checkProfile" });
