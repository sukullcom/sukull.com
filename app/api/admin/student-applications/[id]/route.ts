  ...
  try {
    ...
    if (action === "approve") {
      ...
      try {
        ...
        console.log(`[Student Application] Approval successful for application ${applicationId}`);
      ...
      try {
        ...
        console.log(`[Student Application] Rejection successful for application ${applicationId}`);
