...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    id: "javascript",
    label: "JavaScript",
    logoPath: "/language_logos/javascript.png",
...
console.log('Sum of numbers:', sum);`,
  ...
  typescript: {
    id: "typescript",
    label: "TypeScript",
    logoPath: "/language_logos/typescript.png",
...
console.log('Sum of numbers:', math.sum());`,
  ...
  python: {
    id: "python",
    label: "Python",
    logoPath: "/language_logos/python.png",
...
print(f"Sum of numbers: {numbers_sum}")`,
  ...
  java: {
    id: "java",
    label: "Java",
    logoPath: "/language_logos/java.png",
  ...
  go: {
    id: "go",
    label: "Go",
    logoPath: "/language_logos/go.png",
...
func main() {
  ...
  rust: {
    id: "rust",
    label: "Rust",
    logoPath: "/language_logos/rust.png",
  ...
  cpp: {
    id: "cpp",
    label: "C++",
    logoPath: "/language_logos/cpp.png",
...
int main() {
  ...
  csharp: {
    id: "csharp",
    label: "C#",
    logoPath: "/language_logos/csharp.png",
...
class Program {
  ...
  ruby: {
    id: "ruby",
    label: "Ruby",
    logoPath: "/language_logos/ruby.png",
...
puts "Sum of numbers: #{sum}"`,
  ...
  swift: {
    id: "swift",
    label: "Swift",
    logoPath: "/language_logos/swift.png",
