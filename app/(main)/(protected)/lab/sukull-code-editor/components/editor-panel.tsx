...
<div
  className="relative bg-[#12121a]/90 backdrop-blur rounded-xl border border-white/[0.05] 
  p-4 sm:p-6"
>        {/* Header */}
      ...
      {isShareDialogOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="bg-[#1e1e2e] p-6 rounded-lg w-96 relative">
            ...
            <p className="text-sm text-gray-400 mb-4">Kod paylaşımı yapabilmek için 5000 puana sahip olmalısınız.</p>
